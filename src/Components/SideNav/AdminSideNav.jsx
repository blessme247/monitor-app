    ...
    <aside className="sideNavWrapper">
      <div className="navLinks">
        ...
        <NavLinkComponent
          ...
          linkURL="/"
          linkText="PROFIT"
          secondaryLinkUrl1="/status/grossprofit"
          secondaryLinkUrl2="/status/availablebalance"
          secondaryLinkUrl1Text="Gross Profit"
          secondaryLinkUrl2Text="Available balance"
        />
        <NavLinkComponent
          linkIcon={nairaIcon}
          linkURL="/"
